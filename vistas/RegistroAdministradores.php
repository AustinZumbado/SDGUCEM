...
<body>
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../controlador/cUsuariosAdministradores.php?acc=3" enctype="multipart/form-data" autocomplete="off">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el codigo del usuario <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="50" name="codigoUser" class="form-control" id="validationCustom01" placeholder="Por favor ingrese la cedula del usuario..." value="" required>
                                                <!-- INVALIDO -->
                                            ...
                                            <!-- CEDULA -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese la cedula del Usuario <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="50" name="cedulaUser" class="form-control" id="validationCustom01" placeholder="Por favor ingrese la cedula del usuario..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el cedula de usuario...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                                    Car&aacute;cteres M&aacute;ximos: 50
                                                </div>
                                                <!-- VALIDO -->
                                            ...
                                            <!-- NOMBRE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre del usuario <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="50" name="nombreUser" class="form-control" id="validationCustom01" placeholder="Por favor ingrese la cedula del usuario..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre de usuario...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                            ...
                                            <!-- CORREO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el correo del usuario <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="50" name="correoElectronicoUser" class="form-control" id="validationCustom01" placeholder="usuario@ejemplo.com" value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre de usuario...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                            ...
                                            <!-- APELLIDOS -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese los apellidos del usuario <span class="CampoObligatorio">(*)</span></label></label>
                                                <input type="text" minlength="3" maxlength="50" name="apellidosUser" class="form-control" id="validationCustom01" placeholder="Por favor ingrese la cedula del usuario..." value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre de usuario...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="password" minlength="5" maxlength="15" name="passUser" class="form-control" id="validationCustom01" placeholder="Por favor ingrese la contraseña del usuario..." minlength="5" maxlength="15" data-toggle="tooltip-pink" data-placement="top" title="M&iacute;nimo 5 caracteres" value="" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese una contrase&ntilde;a...<br>
                                                    Caracteres Manimos: 5
                                                    Caracteres Maximos: 15
                                                </div>
                                                <!-- VALIDO -->
                                                <div class="valid-feedback">
                                                    Campo Completado Exitosamente!...
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <select class="form-control custom-select" name="estadoUser" required>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <select class="form-control custom-select" name="tipoUser" required>
   ...
   <!-- /HK Wrapper -->
    ...
    <script src="../vistas/vendors/jasny-bootstrap/dist/js/jasny-bootstrap.min.js"></script>
