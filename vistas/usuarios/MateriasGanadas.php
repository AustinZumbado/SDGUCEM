        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Materias Ganadas</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            <!-- Container -->
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                                    data-feather="archive"></i></span></span>Materias Ganadas</h4>
                </div>
                <!-- /Title -->
                <!-- Row -->
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">Listado de materias ganadas</h5>
                            <p class="mb-40">Estimado usuario(a), en esta secci&oacute;n
                                usted podr&aacute; ver el listado simple de materias ganadas
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                            ...
                                            <tbody>
                                                ...
                                                while ($filas = mysqli_fetch_array($consulta)) {
                                                    echo '<tr>';
                                                    echo '<td>' . $filas['ID Cuatrimestre'] . '</td>';
                                                    echo '<td>' . $filas['Codigo del curso'] . '</td>';
                                                    echo '<td>' . $filas['Curso'] . '</td>';
                                                    echo '<td>' . $filas['Creditos'] . '</td>';
                                                    echo '<td><span class="badge badge-success d-flex justify-content-center">' . $filas['Nota Final'] . '</span></td>';
                                                    echo '<td class="d-flex justify-content-center"><span class="badge badge-danger ">' . $filas['Nota Extraordinaria'] . '</span></td>';
                                                }
                                                ?>
                                            </tbody>
                                        </table>
