                ...
                <div class="row">
                    <div class="col-xl-12 pa-0">
                        <div class="profile-cover-wrap overlay-wrap">
                            <div class="profile-cover-img" style="background-image:url('../vistas/dist/img/trans-bg.jpg');"></div>
								...
								<div class="hk-row"> 
									<div class="col-lg-6">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<div class="text-white text-capitalize display-6 mb-5 font-weight-400">¡Hola <?php echo $_SESSION['vsNombre']; echo " "; echo $_SESSION['vsApellidos']; ?>!</div>
												<div class="font-14 text-white"><span class="mr-5"><span class="font-weight-500 pr-5">Tipo de Usuario:</span><span class="mr-5"> <span class="badge badge-danger"><?php echo $_SESSION['vsTipo'] ?></span></span></span>Codigo de usuario: <span class="badge badge-pink"><?php echo $_SESSION['vsCodigoUser']?></span><span><span class="font-weight-500 pr-5"></span><span></span></span></div>
											</div>
										</div>
									</div>
								</div>
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../controlador/cUsuariosAdministradores.php?acc=9" enctype="multipart/form-data">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12 mb-10">
                                                <input type="hidden" class="form-control custom-select" name="IdUser" value="<?php echo $_SESSION['vsCodigo']?>" required>
                                            ...
                                            <!-- CODIGO -->
                                            <div class="col-md-12 mb-10">
                                                <input type="hidden" class="form-control custom-select" name="CodigoUser" value="<?php echo $_SESSION['vsCodigoUser']?>" required>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Correo Electronico <span class="CampoObligatorio">(*)</span></label>
                                                <input type="email" name="CorreoUser" class="form-control " id="validationCustom01" placeholder="" value="<?php echo $_SESSION['vsCorreoElectronico']?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- CEDULA -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Cedula del Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="CedulaUser" class="form-control prohibido" id="validationCustom01" placeholder="" value="<?php echo $_SESSION['vsCedula']?>" disabled>
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" name="NombreUser" class="form-control prohibido" id="validationCustom01" placeholder="" value="<?php echo $_SESSION['vsNombre'];?>" disabled>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- APELLIDOS -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Apellidos del Usuario <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" name="ApellidosUser" class="form-control prohibido" id="validationCustom01" placeholder="" value="<?php echo $_SESSION['vsApellidos']?>" disabled>
                                                <!--option value="Inactivo">Inactivo</option-->
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor seleccione una opci&oacute;n...
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" name="EstadoUser" class="form-control prohibido" id="validationCustom01" placeholder="" value="<?php echo $_SESSION['vsEstado']?>" disabled>
                                                <!--option value="Inactivo">Inactivo</option-->
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor seleccione una opci&oacute;n...
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" name="TipoUser" class="form-control prohibido" id="validationCustom01" placeholder="" value="<?php echo $_SESSION['vsTipo']?>" disabled>
                                            </select>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor seleccione una opci&oacute;n...
                                            ...
                                            <!-- CONTRASEÑA NUEVA -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Contraseña nueva de Usuario</label>
                                                <input type="password" name="PassUser" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese Contrase&ntilde;a Usuario..." minlength="8" maxlength="12" data-toggle="tooltip-pink" data-placement="top" title="Minimo 8 caracteres, 1 mayuscula, 1 miniscula y un numero." value="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,12}">
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="password" name="ConfirPassUser" class="form-control" id="validationCustom01" placeholder="Por favor Ingrese Contrase&ntilde;a Usuario..." minlength="8" maxlength="12" data-toggle="tooltip-pink" data-placement="top" title="Minimo 8 caracteres, 1 mayuscula, 1 miniscula y un numero." value="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,12}">
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese una contrase&ntilde;a...
                                                </div>
                                            ...
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="file" id="input-file-now" name="FotoPerfilUsuarios" class="dropify"  data-max-file-size="2M" accept="image/x-png,image/jpeg" data-toggle="tooltip-pink" data-placement="top" title="Campo No Obligatorio">
                                        ...
                                        <button class="btn btn-gradient-secondary" type="reset"><i class="fa fa-check"></i> Limpiar formulario</button>
                                    </form>
                                </div>
                            </div>
            </div>
