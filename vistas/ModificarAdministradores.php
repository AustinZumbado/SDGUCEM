        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="./cUsuariosAdministradores.php?acc=4">Administradores</a></li>
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="../controlador/cUsuariosAdministradores.php?acc=12" enctype="multipart/form-data">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                <input type="text" minlength="3" maxlength="50" name="CodigoUser" class="form-control" id="validationCustom01" placeholder="Por favor ingrese la cedula... " value="<?php echo $Usuarios->getCodigo(); ?>" required>
                                                <!-- INVALIDO -->
                                            ...
                                            <!-- CEDULA -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese la cedula <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="50" name="CedulaUser" class="form-control" id="validationCustom01" placeholder="Por favor ingrese la cedula... " value="<?php echo $Usuarios->getCedulaU(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre de usuario...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                            ...
                                            <!-- CORREO ELECTRONICO -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el correo electronico del usuario <span class="CampoObligatorio">(*)</span></label>
                                                <input type="email" minlength="3" maxlength="50" name="CorreoUser" class="form-control" id="validationCustom01" placeholder="Por favor ingrese la cedula... " value="<?php echo $Usuarios->getCorreoElectronico(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre de usuario...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                            ...
                                            <!-- NOMBRE -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el nombre del usuario <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="50" name="NombreUser" class="form-control" id="validationCustom01" placeholder="Por favor ingrese la cedula... " value="<?php echo $Usuarios->getNombre(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre de usuario...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                            ...
                                            <!-- APELLIDOS -->
                                            <div class="col-md-6 mb-10">
                                                <label for="validationCustom01">Ingrese el apellidos del usuario <span class="CampoObligatorio">(*)</span></label>
                                                <input type="text" minlength="3" maxlength="50" name="ApellidosUser" class="form-control" id="validationCustom01" placeholder="Por favor ingrese la cedula... " value="<?php echo $Usuarios->getApellidos(); ?>" required>
                                                <!-- INVALIDO -->
                                                <div class="invalid-feedback">
                                                    Por favor ingrese el nombre de usuario...<br>
                                                    Car&aacute;cteres M&iacute;nimos: 3
                                            ...
                                            <div class="col-md-6 mb-10">
                                                ...
                                                }elseif($Usuarios->getEstados() == "Inactivo"){
                                            ...
                                            <label for="validationCustom01">Estado Usuario <span class="CampoObligatorio">(*)</span></label>
                                                ...
                                                <option value="<?php echo $Usuarios->getTipoUser(); ?>"><?php echo $Usuarios->getTipoUser(); ?></option>
                                                <?php
                                                if($Usuarios->getTipoUser() == "Administrativo"){
                                                    echo '<option value="Estudiante">Estudiante</option>';
                                                }elseif($Usuarios->getTipoUser() == "Estudiante"){
