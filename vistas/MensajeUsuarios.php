...
<body>
                ...
                <div class="row">
                    <div class="col-xl-5 pa-0">
                        <div id="owl_demo_1" class="owl-carousel dots-on-item owl-theme">
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(../vistas/dist/img/BGLogin1.jpg);">
                            ...
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(../vistas/dist/img/BGLogin2.jpg);">
                                <div class="auth-cover-info py-xl-0 pt-100 pb-50">
                                    <div class="auth-cover-content text-center w-xxl-75 w-sm-90 w-xs-100">
                    ...
                    <div class="col-xl-7 pa-0">
                        <div class="auth-form-wrap py-xl-0 py-20">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                ...
                                <img class="msjError" src="../vistas/dist/img/ErrorMsj.png">
                                ...
                                <a href="../controlador/ControlLogin.php?acc=1"><button class="btn btn-primary btn-block espaciado-btn" type="submit"><i class="fa fa-plus"></i> Intentar Otra Vez</button></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="../vistas/dist/js/login-data.js"></script>
