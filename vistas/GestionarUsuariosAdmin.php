...
<body>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="archive"></i></span></span>Gestionar Usuarios</h4>
                </div>
                <!-- /Title -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                                ...
                                                <tbody>
                                                    ...
                                                    while($filas=mysqli_fetch_array($consulta)){
                                                       ...
                                                       echo '<td><a href="cUsuariosAdministradores.php?acc=11&cod='.$filas['ID'].'" data-toggle="tooltip-neon" data-placement="top" title="Modificar"> <i class="fa fa-edit edit-table modificar"></i></a></td>';
                                                       echo '<td><a href="cUsuariosAdministradores.php?acc=11&cod='.$filas['ID'].'" data-toggle="tooltip-neon" data-placement="top" title="Cursos"> <i class="fa fa-graduation-cap edit-table Cursos"></i></a></td>';
                                                       echo '<td><a href="cUsuariosAdministradores.php?acc=10&cod='.$filas['ID'].'" data-toggle="tooltip-danger" data-placement="top" title="Eliminar"> <i class="fa fa-trash-o edit-table eliminar" onclick="'.$ConfirmarDepuracion.'"></i></a></td>';
                                                       echo '</tr>';
                                                    }
                                                ?>
                                                </tbody>
    ...
    <script src="../vistas/vendors/bootstrap-table/dist/bootstrap-table.min.js"></script>
    <script src="../vistas/dist/js/bootstrap-table-data.js"></script>
    ...
    <!-- Peity JavaScript -->
    <script src="../vistas/vendors/peity/jquery.peity.min.js"></script>
    <script src="../vistas/dist/js/peity-data.js"></script>
