...
// CARGANDO modelos DE CASOS DE CLIENTES
require('../modelos/mReportesGestiones.php');
$Usuarios=new ReportesClientes();
// ACC -> ACCION CONTROLLADOR {URL} 
if(isset($_GET['acc']))
{
...
switch ($accion) 
{
    ...
    case 1:
        if($_SESSION['vsTipo']=="Administrador"){
		  ...
		  require('../vistas/BusquedaAvanzadaReportesClientes.php');
        }else if($_SESSION['vsTipo']=="Usuario"){
            $consulta=$Usuarios->ConsultarReportesClientes($cnn);
          require('../vistas/Empleados/BusquedaAvanzadaReportesClientes.php');
        }else{
    ...
    case 2: 
        if($_SESSION['vsTipo']=="Administrador"){
		  require('../vistas/RegistroReportesClientes.php'); 
        }else if($_SESSION['vsTipo']=="Usuario"){
            require('../vistas/Empleados/RegistroReportesClientes.php');
        }else{
            header ('location:../index.php');
        } 
        $cnn->close(); // CERRANDO CONEXION
    ...
    case 4: 
        if($_SESSION['vsTipo']=="Administrador"){
            $consulta=$Usuarios->ConsultarReportesClientes($cnn);
            require('../vistas/GestionarReportesClientes.php'); 
        }else if($_SESSION['vsTipo']=="Usuario"){
            $consulta=$Usuarios->ConsultarReportesClientes($cnn);
            require('../vistas/Empleados/GestionarReportesClientes.php'); 
        }else{
            header ('location:../index.php');
        } 
        $cnn->close(); // CERRANDO CONEXION
    ...
    case 5: 
        if($_SESSION['vsTipo']=="Administrador"){
            $consulta=$Usuarios->ConsultarReportesClientes($cnn);
            require('../vistas/ExportarReportesClientes.php'); 
        }else if($_SESSION['vsTipo']=="Usuario"){
            $consulta=$Usuarios->ConsultarReportesClientes($cnn);
            require('../vistas/Empleados/ExportarReportesClientes.php'); 
        }else{
            header ('location:../index.php');
        } 
        $cnn->close(); // CERRANDO CONEXION
    ...
    case 8:
        if($_SESSION['vsTipo']=="Administrador"){
            ...
            require('../vistas/ModificarCasosClientes.php');  
        }else if($_SESSION['vsTipo']=="Usuario"){
            $ID_CasosClientes=$_GET['cod'];
            $consulta=$Usuarios->ConsultarUnReportePlataforma($cnn,$ID_CasosClientes);
            require('../vistas/Empleados/ModificarCasosClientes.php');  
        }
        else{
            header ('location:../index.php');
        }
    ...
    case 10:
        if($_SESSION['vsTipo']=="Administrador"){
            $consulta=$Usuarios->ConsultarReportesClientes($cnn);
            require('../vistas/HistorialCasosReportesClientes.php');
        }else if($_SESSION['vsTipo']=="Usuario"){
            $consulta=$Usuarios->ConsultarReportesClientes($cnn);
            require('../vistas/Empleados/HistorialCasosClientesEmpleados.php');
        }else{
            header ('location:../index.php');
        }
        $cnn->close(); // CERRANDO CONEXION
    ...
    case 'reportecartaestudiante':
      if($_SESSION['vsTipo']=="Administrador" || $_SESSION['vsTipo']=="Estudiante"){
         // CONSULTA Y ENVIO DE DATOS A REPORTES
        $resp=$Usuarios->ConsultarCartaEstudiante($cnn,$_SESSION['vsCedula']);
